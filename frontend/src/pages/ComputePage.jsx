...
const FUNCTIONS = [
  {
    value: 'average_age',
    label: 'Average Age',
    desc: 'Compute mean age across encrypted records',
    icon: '∑',
    vector: '[1,0,0,0,0]',
  },
  {
    value: 'disease_frequency',
    label: 'Disease Frequency',
    desc: 'Count occurrences of each disease type',
    icon: '⊞',
    vector: '[0,0,1,0,0]',
  },
  {
    ...
    desc: 'Statistical risk score distribution',
    icon: '◈',
    vector: '[0,0,0,0,1]',
  },
  {
    value: 'avg_blood_pressure',
    label: 'Avg Blood Pressure',
    desc: 'Mean blood pressure across population',
    icon: '♥',
    vector: '[0,0,0,1,0]',
  },
  {
    value: 'risk_score_by_disease',
    label: 'Risk by Disease',
    desc: 'Average risk score per disease group',
    icon: '⊟',
    vector: '[0,0,1,0,1]',
  },
];
    ...
    <div style={{ padding: '28px 32px', maxWidth: 1000, margin: '0 auto' }}>
      <div style={{ marginBottom: 28, animation: 'fadeInUp 0.4s ease' }}>
        ...
        <p style={{ fontSize: 12, color: 'var(--text-secondary)' }}>
          Request function-specific keys and run secure computations on
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 20 }}>
          ...
          <Card style={{ animation: 'fadeInUp 0.5s ease' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
              <Select
                ...
                onChange={(e) =>
                  setFilter((f) => ({ ...f, disease: e.target.value }))
                }
              >
              ...
              >
                <Input
                  ...
                  onChange={(e) =>
                    setFilter((f) => ({ ...f, age_min: e.target.value }))
                  }
                />
                <Input
                  label="Age Max"
                  ...
                  onChange={(e) =>
                    setFilter((f) => ({ ...f, age_max: e.target.value }))
                  }
                />
              </div>
            </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          ...
          <Card style={{ animation: 'fadeInUp 0.5s ease' }}>
            ...
            >
              <div
                style={{
                  ...
                  background: keyRequested
                    ? 'rgba(32,200,160,0.2)'
                    : 'rgba(139,92,246,0.2)',
                  fontSize: 10,
                  fontFamily: 'var(--font-mono)',
                  color: keyRequested ? '#20c8a0' : '#8b5cf6',
                }}
              >
                {keyRequested ? '✓' : '1'}
              </div>
              <span
                style={{
                  fontSize: 12,
                  fontWeight: 500,
                  color: keyRequested ? '#20c8a0' : 'var(--text-primary)',
                }}
              >
            ...
            >
              A function-specific key is required before computation. The key
              limits your access to only the requested function.
            </p>
            {keyRequested ? (
              <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                <Alert type="success">
                  Function key granted for <strong>{fnObj?.label}</strong>
                </Alert>
                <div
                  style={{
                    background: 'var(--bg-elevated)',
          ...
          >
            ...
            >
              ...
              <span
                style={{
                  fontSize: 12,
                  fontWeight: 500,
                  color: result ? '#20c8a0' : 'var(--text-primary)',
                }}
              >
                Execute Computation
              </span>
            ...
            >
              Runs FE/MPC protocol on encrypted data. Only the aggregate result
              is revealed.
            </p>
            <Button
              onClick={handleCompute}
              disabled={!keyRequested || computing}
                ...
                >
                  {(result.breakdown || []).map((b, i) => (
                    ...
                    >
                      ...
                      <MonoValue>{b.count || b.average_risk}</MonoValue>
                    </div>
                  ))}
                </div>
              )}

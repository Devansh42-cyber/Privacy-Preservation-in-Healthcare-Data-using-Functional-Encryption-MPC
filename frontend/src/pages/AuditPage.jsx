    ...
    <div style={{ padding: '28px 32px', maxWidth: 1100, margin: '0 auto' }}>
      ...
      <div style={{ marginBottom: 28, animation: 'fadeInUp 0.4s ease' }}>
        ...
        <p style={{ fontSize: 12, color: 'var(--text-secondary)' }}>
          Complete record of system access, computation requests, and key
          generation events.
        </p>
      </div>
      ...
      >
        {[
          ...
          <Card
            ...
            style={{
              padding: '16px 20px',
              animation: `fadeInUp ${0.3 + i * 0.08}s ease`,
            }}
          >
            <div
              style={{
            ...
            <tbody>
              {filtered.map((log, i) => (
                ...
                >
                  ...
                  <td style={{ padding: '10px 16px' }}>
                    <Badge
                      variant={TYPE_CONFIG[log.action]?.variant || 'muted'}
                    >
                      {log.action}
                    </Badge>
                  </td>
                    ...
                    >
                      <div
                        style={{
                          ...
                          borderRadius: '50%',
                          background:
                            log.status === 'success' ? '#20c8a0' : '#ef4444',
                        }}
                      />
                      <span
                        style={{

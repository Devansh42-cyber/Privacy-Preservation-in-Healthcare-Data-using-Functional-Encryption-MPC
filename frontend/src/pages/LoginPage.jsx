    ...
    >
      ...
      <div
        style={{
          ...
          height: 400,
          background:
            'radial-gradient(circle, rgba(32,200,160,0.06) 0%, transparent 70%)',
          borderRadius: '50%',
          filter: 'blur(40px)',
        }}
      />
                ...
                <>
                  <div
                    style={{
                      width: 14,
                      height: 14,
                      border: '2px solid rgba(2,4,8,0.2)',
                      borderTop: '2px solid #020408',
                      borderRadius: '50%',
          ...
          >
            {DEMO_ACCOUNTS.map((acct) => (
              <button
                ...
                onMouseEnter={(e) =>
                  (e.currentTarget.style.borderColor = `${acct.color}50`)
                }
                onMouseLeave={(e) =>
                  (e.currentTarget.style.borderColor = `${acct.color}25`)
                }
              >
                <div
                  style={{
